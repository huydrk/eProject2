...
<body>
	<header id="header"><!--header-->
		<div class="header_top navbar-inverse navbar-fixed-to"><!--header_top-->
			<div class="container">
				<div class="row">
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +84 70 331 8572</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> aptech@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
